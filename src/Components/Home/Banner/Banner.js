...
const Banner = () => {
    return (
        <div class="hero min-h-screen  bg-white" style={{backgroundImage: 'url(https://i.ibb.co/pxWv2Kv/pexels-lex-ger-4294075.jpg)'}}>
            <div class="hero-overlay bg-opacity-60"></div>
            <div className="hero min-h-screen ">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <img src="https://i.ibb.co/pxWv2Kv/pexels-lex-ger-4294075.jpg" className="max-w-sm rounded-lg shadow-2xl" />
